...
- Name: 11-extensions.spec.ts >> Extensions >> plugins tab loads
- Location: 11-extensions.spec.ts:16:7
...
Call log:
  - waiting for locator('aside').first().getByRole('button', { name: /Plugins/i }).first()
