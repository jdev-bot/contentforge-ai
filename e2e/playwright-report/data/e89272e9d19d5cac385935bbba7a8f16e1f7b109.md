...
- Name: 02-dashboard-shell.spec.ts >> Dashboard Shell >> Ctrl+N opens content creation inline
- Location: 02-dashboard-shell.spec.ts:47:7
...
Locator: getByText(/paste text|source|title/i).first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText(/paste text|source|title/i).first()
...
- generic [ref=e1]:
  ...
  - generic [ref=e4]:
    ...
    - contentinfo [ref=e377]:
      - generic [ref=e379]:
        - paragraph [ref=e380]: © 2026 ContentForge AI. All rights reserved.
        - navigation [ref=e381]:
          ...
          - link "Cookie Policy" [ref=e384] [cursor=pointer]:
            ...
            - img [ref=e385]
            - text: Cookie Policy
          - link "DMCA Notice" [ref=e387] [cursor=pointer]:
            - /url: /legal/dmca
