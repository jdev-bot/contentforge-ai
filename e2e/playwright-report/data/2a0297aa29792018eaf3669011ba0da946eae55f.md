...
- Name: 11-extensions.spec.ts >> Extensions >> integration hub tab loads
- Location: 11-extensions.spec.ts:144:7
...
Call log:
  - waiting for locator('aside').first().getByRole('button', { name: /Integrations Hub/i }).first()
