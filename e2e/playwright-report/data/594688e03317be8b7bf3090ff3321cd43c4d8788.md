...
- Name: 12-system-admin.spec.ts >> System & Admin >> retention tab loads
- Location: 12-system-admin.spec.ts:93:7
...
Call log:
  - waiting for locator('aside').first().getByRole('button', { name: /Retention/i }).first()
