...
- Name: 11-extensions.spec.ts >> Extensions >> SLA tab loads
- Location: 11-extensions.spec.ts:152:7
...
Call log:
  - waiting for locator('aside').first().getByRole('button', { name: /SLA/i }).first()
