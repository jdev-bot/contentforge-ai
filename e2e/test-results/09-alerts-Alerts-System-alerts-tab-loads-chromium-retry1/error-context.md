...
- Name: 09-alerts.spec.ts >> Alerts System >> alerts tab loads
- Location: 09-alerts.spec.ts:13:7
...
Locator: getByText(/alert|notification/i).first()
Expected: visible
Timeout: 4000ms
...
Call log:
  ...
  - waiting for getByText(/alert|notification/i).first()
