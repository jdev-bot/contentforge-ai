...
class TestProjectCreate:
    ...
    def test_create_project_success(self, mock_auth_client, mock_projects_client, client, sample_project):
        ...
        mock_projects_client.return_value.table.return_value.insert.return_value.execute.return_value = mock_response
...
class TestProjectList:
    ...
    @patch('app.routers.projects.get_supabase_client')
    @patch('app.routers.auth.get_supabase_client')
    def test_list_projects_success(self, mock_auth_client, mock_projects_client, client, sample_project):
        ...
        mock_projects_client.return_value.table.return_value.select.return_value.eq.return_value.order.return_value.execute.return_value = mock_response
...
class TestProjectGet:
    ...
    @patch('app.routers.projects.get_supabase_client')
    @patch('app.routers.auth.get_supabase_client')
    def test_get_project_success(self, mock_auth_client, mock_projects_client, client, sample_project):
...
class TestProjectUpdate:
    ...
    @patch('app.routers.projects.get_supabase_client')
    @patch('app.routers.auth.get_supabase_client')
    def test_update_project_success(self, mock_auth_client, mock_projects_client, client, sample_project):
        ...
        mock_table.select.return_value.eq.return_value.eq.return_value.single.return_value.execute.return_value = existing_response
        mock_table.update.return_value.eq.return_value.execute.return_value = updated_response
...
class TestProjectDelete:
    ...
    @patch('app.routers.projects.get_supabase_client')
    @patch('app.routers.auth.get_supabase_client')
    def test_delete_project_success(self, mock_auth_client, mock_projects_client, client, sample_project):
        ...
        mock_projects_client.return_value.table.return_value.update.return_value.eq.return_value.eq.return_value.execute.return_value = mock_response
