...
class TestAuthRegister:
    ...
    def test_register_success(self, client):
        ...
        with patch(
            "app.routers.auth.get_supabase_client", return_value=builder.build()
        ):
            # Act
    ...
    def test_register_existing_email(self, client):
        ...
        with patch("app.routers.auth.get_supabase_client", return_value=mock_client):
            ...
            assert (
                ...
                or "registration failed" in response.json()["detail"].lower()
            )
...
class TestAuthLogin:
    ...
    def test_login_success(self, client):
        ...
        mock_session = create_mock_auth_session(
            user=mock_user, access_token="valid-token-123"
        )
...
class TestAuthMe:
    ...
    def test_get_current_user_success(self, client):
        ...
        try:
            with patch(
                "app.routers.auth.get_supabase_client", return_value=mock_client
            ):
