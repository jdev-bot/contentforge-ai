...
def cached(ttl: Optional[int] = None, prefix: str = "", key_func: Optional[Callable] = None):
    """
...
def cache_user_profile(user_id: str, profile: dict, ttl: int = CACHE_TTL["user_profile"]):
...
def cache_project_list(user_id: str, projects: list, ttl: int = CACHE_TTL["project_list"]):
