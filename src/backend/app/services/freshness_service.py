...
class FreshnessFactors:
    ...
    TRENDING_KEYWORDS = [
        ...
        "automation", "workflow", "productivity", "content",
        "marketing", "social media", "growth", "analytics",
        "data", "insights", "trends", "2026", "strategy"
    ]
...
class FreshnessService:
    ...
    def _count_generated_assets(self, content_id: str) -> int:
        ...
        try:
            ...
            result = supabase.table("generated_assets")\
    ...
    def calculate_trend_score(self, content: Dict[str, Any]) -> int:
        ...
        trending_matches = sum(
            1 for keyword in self.factors.TRENDING_KEYWORDS
